...
public class CodeGenerator {
    ...
    private static final String dataUrl = "jdbc:mysql://localhost:3306/myblog?serverTimezone=UTC&useUnicode=true&characterEncoding=utf8&characterSetResults=utf8";
